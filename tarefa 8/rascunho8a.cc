/*
Intro2cs, 2020a,
Ex #8: This program prints the number that is dividing
by all his rigt side in the array and by his left side.
Writen by: Eliane Dahab : id 338038839
Login: elianech 
Class: b  
*/
...
void fill_array(int array[N], int i)
{
    ...
    cin >> array[i];
    i += 1; // now in the next requrstion we get inside to the next cell! like for!
    fill_array(array, i);
}
//------------------------------------
